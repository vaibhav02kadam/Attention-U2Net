...
# We have commented some of the attention maps which could be uncommented and activated if you have more compute.
...
# Simple Attention Unet derived attention block implementation for U2Net
class AttU2Net_normal(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):
        super(AttU2Net_normal, self).__init__()
