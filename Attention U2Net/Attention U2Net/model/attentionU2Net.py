...
class AU7(nn.Module):  
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        ...
        # self.att5 = Attention_modified(mid_ch, mid_ch)
        self.rebnconv5d = REBNCONV(mid_ch * 2, mid_ch, dilate=1)
        
        # self.att4 = Attention_modified(mid_ch, mid_ch)
        self.rebnconv4d = REBNCONV(mid_ch * 2, mid_ch, dilate=1)
        
        self.att3 = Attention_modified(mid_ch, mid_ch)
        self.rebnconv3d = REBNCONV(mid_ch * 2, mid_ch, dilate=1)

        self.att2 = Attention_modified(mid_ch, mid_ch)
        self.rebnconv2d = REBNCONV(mid_ch * 2, mid_ch, dilate=1)

        self.att1 = Attention_modified(mid_ch, mid_ch)
...
class AU4F(nn.Module):
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        super(AU4F, self).__init__()
...
class AttU2Net(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):
        ...
        self.stage1 = AU7(in_ch, 32, 64)
        self.pool12 = nn.MaxPool2d(2, stride=2, ceil_mode=True)

        self.stage2 = AU6(64, 32, 128)
        self.pool23 = nn.MaxPool2d(2, stride=2, ceil_mode=True)

        self.stage3 = AU5(128, 64, 256)
        self.pool34 = nn.MaxPool2d(2, stride=2, ceil_mode=True)

        self.stage4 = AU4(256, 128, 512)
        self.pool45 = nn.MaxPool2d(2, stride=2, ceil_mode=True)

        self.stage5 = AU4F(512, 256, 512) 
        self.pool56 = nn.MaxPool2d(2, stride=2, ceil_mode=True)

        self.stage6 = AU4F(512, 256, 512) 

        # decoder
        self.stage5d = AU4F(1024, 256, 512)
        self.stage4d = AU4(1024, 128, 256)
        self.stage3d = AU5(512, 64, 128)
        self.stage2d = AU6(256, 32, 64)
        self.stage1d = AU7(128, 16, 64)
